    ...
    <header className="hero-section">
      <div className="container">
        ...
        <div className="hero__contrast">
          <p>Arrêtez de payer des agences pour des mois de développement.<br />Nous livrons la qualité en une fraction du temps pour 50% du prix.</p>
        </div>
    ...
    <section className="section problem-section">
      <div className="container">
        ...
        <div className="section-cta">
          <Link
            // className="button button--secondary button--lg vibe-button-outline pulse"
            className="button button--primary button--lg vibe-button"
      ...
      <div className="container">
        ...
        <div className="pricing-table">
          <div className="pricing-column traditional">
            <h3>Traditionnel</h3>
            <div className="price">12 000 € - <br />15 000 €</div>
            <p>4 à 8 semaines</p>
            <p>Frais cachés</p>
            <Link
